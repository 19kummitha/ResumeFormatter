...
def extract_resume_details_with_azure(text: str) -> dict:
    ...
    system_prompt = (
        ...
        "- professional_experience: [check for summary in the resume, it should be like: bullet point 1, bullet point 2,bullet point N]\n"
        "- Each item should be a clear, concise bullet point summarizing.\n"
        "- If the total character count of all bullet points exceeds 1400 characters and not less than 1000 characters total\n"
        "- Rephrase and shorten the bullet points.\n"
        "- Keep only the most relevant and impactful information.\n"
        "- The final output must not exceed 1400 characters total (combined) and not less than 1000 characters total(combined).\n"
        "- Do not repeat information or use unnecessary details.\n"
        "- Ensure the result remains in bullet point format.\n"
...
def extract_resume_details_with_azure_vision(images: list) -> dict:
    ...
    system_prompt = (
        ...
        "- professional_experience: [check for summary in the resume, it should be like: bullet point 1, bullet point 2,bullet point N]\n"
        "- Each item should be a clear, concise bullet point summarizing .\n"
        "- If the total character count of all bullet points exceeds 1400 characters: and not less than 1000 characters\n"
        "- Rephrase and shorten the bullet points.\n"
        "- Keep only the most relevant and impactful information.\n"
        "- The final output must not exceed 1400 characters total (combined) and not less than 1000 characters total (combined).\n"
        "- Do not repeat information or use unnecessary details.\n"
